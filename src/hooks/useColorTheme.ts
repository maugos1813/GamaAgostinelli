...
export const COLOR_THEMES: ColorTheme[] = [
  ...
  },
  {
    ...
    lightVars: {
      "--primary": "143 71% 48%",
      "--primary-foreground": "0 0% 100%",
      "--primary-glow": "143 71% 58%",
      "--accent": "143 71% 48%",
      "--accent-foreground": "0 0% 100%",
      "--ring": "143 71% 48%",
      "--sidebar-primary": "143 71% 48%",
      "--sidebar-primary-foreground": "0 0% 100%",
      "--sidebar-ring": "143 71% 48%",
      "--gradient-primary": "linear-gradient(135deg, hsl(143 71% 48%), hsl(158 68% 38%))",
      "--gradient-radial": "radial-gradient(circle at 50% 0%, hsl(143 71% 48% / 0.10), transparent 60%)",
      "--shadow-glow": "0 0 60px hsl(143 71% 48% / 0.22)",
    },
  },
  {
    id: "orange",
