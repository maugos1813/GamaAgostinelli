...
const services = [
  {
    ...
    desc: "Cada elemento diseñado para guiar al usuario hacia la acción.",
    sub: "No es solo diseño, es conversión.",
  },
  {
    icon: Code2,
    title: "Desarrollo ultrarrápido",
    desc: "Carga en milisegundos. Sin perder clientes por lentitud.",
    sub: "Cada segundo cuenta en tu tasa de conversión.",
  },
  {
    icon: Smartphone,
    title: "Mobile-first real",
    desc: "Más del 70% del tráfico es móvil. Diseñamos para convertir desde el teléfono.",
    sub: "Tu cliente decide en segundos.",
  },
  {
    icon: Search,
    title: "SEO técnico",
    desc: "Estructuramos tu landing para que Google la entienda y posicione mejor.",
    sub: "Más visibilidad, más oportunidades de venta.",
  },
  {
    icon: LineChart,
    title: "A/B testing continuo",
    desc: "Medimos, probamos y mejoramos constantemente para aumentar conversiones.",
    sub: "Tu landing mejora con el tiempo.",
  },
  {
    icon: Rocket,
    title: "Lanzamiento y soporte",
    desc: "Publicamos, monitoreamos y optimizamos para que siga generando resultados.",
    sub: "Soporte continuo post-lanzamiento.",
  },
];
